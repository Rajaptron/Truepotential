...
<head>
    <title>Sign In- True Potential</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
								...
								<div class="row">
									...
									<div class="col-md-12">	
										<div class="single-input">
											...
											<div class="form-group">
												<input type="text" class="form-control" value="<?php echo $_GET['phone'];?>" placeholder="Mobile" aria-label="Name" name="phone">				    										    						    
											</div>
										</div>
									</div>	
										...
										<div class="single-input">
											<i class="fas fa-phone"></i>																  
											<div class="form-group">
												<input type="text" class="form-control" placeholder="Mobile" aria-label="Name" name="phone">				    										    						    
											</div>
										</div>
									</div>	
									...
									<div class="col-md-12">
										<div class="sign-in-btn">	
                                                                                  ...
                                                                                  <button type="submit" class="btn btn-primary btn-lg" name="submit" id="truesign"> Sign in </button>										
                                                                                  <span><a href="recovery.php">Forget Password?</a></span> <br/>
