 ...
 if(isset($_POST['submit']))
{
         ...
         $result=mysqli_query($con,"UPDATE webcontent SET organisation='$content' where sno=1");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Our Organisation </h4>
                                </div>
                                ...
                                <form method="POST" action="#">
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleInputEmail1" placeholder="Content" name="content"><?php echo $organisation;?></textarea>
                                  </div>
