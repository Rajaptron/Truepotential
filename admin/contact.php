                            ...
                            <div class="col-md-12">
                               ...
                               <form method="POST" action="#">
                                 <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Address" name="email">
                                  </div>
                                   
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Phone</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Phone" name="email">
                                  </div>
                                    ...
                                    <input type="url" class="form-control" id="exampleInputEmail1" placeholder="Facebook" name="email">
                                  </div>
                                   
                                    <div class="form-group">
                                    <label for="exampleInputEmail1">Twitter</label>
                                    <input type="url" class="form-control" id="exampleInputEmail1" placeholder="Twitter" name="email">
                                  </div>
                                   
                                   <div class="form-group">
                                    <label for="exampleInputEmail1">Instagram </label>
                                    <input type="url" class="form-control" id="exampleInputEmail1" placeholder="Instagram" name="email">
                                  </div>
                                   
                                   <div class="form-group">
                                    <label for="exampleInputEmail1">Google+</label>
                                    <input type="url" class="form-control" id="exampleInputEmail1" placeholder="Google+" name="email">
                                  </div>
