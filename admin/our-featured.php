 ...
 if(isset($_POST['submit']))
{
         ...
         $result=mysqli_query($con,"UPDATE webcontent SET featured='$content' where sno=1");
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="panel-heading clearfix">
                                    <h4 class="panel-title">Our Featured</h4>
                                </div>
                                <div class="panel-body basic-form-panel">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleInputEmail1" placeholder="Content" name="content"><?php echo $featured;?></textarea>
                                  </div>
