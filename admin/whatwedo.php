 ...
 if(isset($_POST['submit']))
{
         ...
         $result=mysqli_query($con,"UPDATE webcontent SET whatwedo='$content' where sno=1");
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel-body basic-form-panel">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleInputEmail1" placeholder="Content" name="content"> <?php echo $whatwedo;?></textarea>
                                  </div>
